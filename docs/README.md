...
- [docs/dev-setup.md](dev-setup.md): install, environment, run, verification, local data
...
Historical handoff and project-note files have been reduced to short pointers so they no longer act as competing documentation.
