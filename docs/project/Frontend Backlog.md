...
- `/extract` (continued) — App.tsx is now ~1,250 lines; remaining split candidates are `AccountCard`, `FolderConflictCard`, `CustomFieldConflictCard`, and `deriveReviewState`, but all are tightly coupled to App state
